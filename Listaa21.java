...
public class Listaa21 {

	public static void main(String[] args) {
		System.out.println(somar(5, 3)); 
		linha();
        System.out.println(subtrair(10, 4));
        linha();
        ...
        linha();
        System.out.println(aprovacao(5, 7)); 
        linha();
        System.out.println(numero(9, 9)); 
        linha();
        System.out.println(celsius(30)); 
        linha();
        System.out.println(retangulo(5, 3)); 
        linha();
        System.out.println(mensagem("Isadora")); 
        linha();
        System.out.println(nomes("Taylor", "Swift")); 
        linha();
